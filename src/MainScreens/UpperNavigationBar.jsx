...
export default function UpperNavigationBar() {
    ...
    return (
            <div style={{position: 'fixed', top: '0', left: '0', display: 'flex', justifyContent: 'flex-end', width: '100%', alignItems:'center', height: '7.5%', backgroundColor: '#252738', overflowX: 'auto', zIndex: 1 }}>
