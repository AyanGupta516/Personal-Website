...
export default function UpperNavigationBar() {
    ...
    return (
            <div style={{position: 'absolute', top: '0%', left: '50%', transform: 'translateX(-50%)', display: 'flex', justifyContent: 'flex-end', width: '100%', alignItems:'center', height: '7.5%', backgroundColor: '#252738', overflowX: 'auto' }}>
                ...
                <NavLink to = '/Experience' o nMouseEnter = {() => handleHovered('Experience')} onMouseLeave = {removehover} style = {{color: isHovered === 'Experience' ? '#3BBA9C': 'white',  marginRight: '70px', fontWeight:'bold', fontSize: '18px'}}> Projects & Experience </NavLink>
