...
export default function UpperNavigationBar() {
    ...
    return (
            <div style={{position: 'fixed', top: '0', left: '0', display: 'flex', justifyContent: 'flex-end', width: '100%', alignItems:'center', height: '7.5%', backgroundColor: '#252738', overflowX: 'auto' }}>
                ...
                <NavLink to = '/Experience' o nMouseEnter = {() => handleHovered('Experience')} onMouseLeave = {removehover} style = {{color: isHovered === 'Experience' ? '#3BBA9C': 'white',  marginRight: '4rem', fontWeight:'bold', fontSize: '1.15rem'}}> Projects & Experience </NavLink>
