...
export default function UpperNavigationBar() {
    ...
    return (
        <>
            <div style={{position: 'fixed', top: '0', left: '0', display: 'flex', justifyContent: 'flex-end', width: '100%', alignItems:'center', height: '7.5%', backgroundColor: LightMode? '#EAEAEA':'#252738', overflow: 'auto', zIndex: 1 }}>
                <ToggleSwitch/>
                ...
                <NavLink to = '/Experience' onMouseEnter = {() => handleHovered('Experience')} onMouseLeave = {removehover} style = {{color: LightMode ? (isHovered === 'Experience' ? '#5596e6': 'black') : (isHovered === 'Experience' ? '#3BBA9C': 'white'),  marginRight: '3.5%', fontWeight:'bold', fontSize: '105%'}}> Projects & Experience </NavLink>
